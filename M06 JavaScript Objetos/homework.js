...
function tieneEmail(objetoUsuario) {
  ...
  // Tu código:
  var checkEmail = objetoUsuario.hasOwnProperty("email");
  return checkEmail;
}
...
function tienePropiedad(objeto, propiedad) {
  ...
  // En ese caso retornar true. Caso contrario, false.
  // Tu código:
  var checkProperty = objeto.hasOwnProperty(propiedad);
...
function verificarPassword(objetoUsuario, password) {
  ...
  // En ese caso retornar true. Caso contrario, false.
  // Tu código:
  var introducido = password;
  var clave = objetoUsuario["password"];
  if (introducido === clave) {
    return true;
  } else {
    return false;
  }
...
function sumarLikesDeUsuario(objetoUsuario) {
  ...
  for (var i = 0; i < posts.length; i++) {
    sumarLikes = sumarLikes + posts[i].likes;
  }
...
function agregarMetodoCalculoDescuento(objetoProducto) {
  ...
  var aPagar = objetoProducto.calcularPrecioDescuento();
  console.log(aPagar);
}
